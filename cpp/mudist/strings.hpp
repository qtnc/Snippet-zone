...
split(v, str, boost::is_any_of(delims), boost::token_compress_on);
return v;
}
...
inline std::string toString (const std::wstring& ws, int cp = DEFAULT_CP, int inOffset=0, int outOffset = 0) {
...
inline std::wstring toWString (const std::string& s, int cp = DEFAULT_CP, int inOffset=0, int outOffset = 0) {
